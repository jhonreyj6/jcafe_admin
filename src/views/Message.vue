<template>
    <div>
        ...
        <div class="flex flex-row gap-4 ml-64">
                        ...
                        <div class="p-2 flex flex-row gap-2 items-center">
                            ...
                            <div class="w-full">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="ms-auto text-gray-400 text-sm">
                                        4h
                                    </div>
                                </div>
                                <p>messages</p>
            ...
            <div class="ml-80 pt-16 h-screen">
                <div class="h-full relative">
                    ...
                    <div class="h-full py-20 overflow-y-scroll">
                        <div class="px-6 py-2 flex flex-row gap-4">
                            <div class="border shadow py-2 rounded px-4">
                                Do magna eiusmod magna dolor culpa irure quis
                                qui incididunt adipisicing adipisicing. Do magna
                                eiusmod magna dolor culpa irure quis qui
                                incididunt adipisicing adipisicing. Do magna
                                eiusmod magna dolor culpa irure quis qui
